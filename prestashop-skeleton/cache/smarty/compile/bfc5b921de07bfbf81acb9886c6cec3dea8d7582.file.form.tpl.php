<?php /* Smarty version Smarty-3.1.8, created on 2012-11-01 16:46:23
         compiled from "/www/htdocs/mrtc/testIDT/adm/themes/idt/template/controllers/products/helpers/form/form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:5747891035092994f5f6f02-78884785%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bfc5b921de07bfbf81acb9886c6cec3dea8d7582' => 
    array (
      0 => '/www/htdocs/mrtc/testIDT/adm/themes/idt/template/controllers/products/helpers/form/form.tpl',
      1 => 1348647538,
      2 => 'file',
    ),
    ...
    '3be338b8e30ac32c2dab05b8cba9dfe4ff0a9180' => 
    array (
      0 => '/www/htdocs/mrtc/testIDT/adm/themes/idt/template/helpers/form/form_supervision.tpl',
      1 => 1351783743,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '5747891035092994f5f6f02-78884785',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_50929950c9ac82_01198325',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_50929950c9ac82_01198325')) {function content_50929950c9ac82_01198325($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/www/htdocs/mrtc/testIDT/tools/smarty/plugins/modifier.escape.php';
?>
...
<?php }?>
<?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2012-11-01 16:46:24
         compiled from "/www/htdocs/mrtc/testIDT/adm/themes/idt/template/helpers/form/form_group.tpl" */ ?>
<?php if ($_valid && !is_callable('content_509299502dc007_22876779')) {function content_509299502dc007_22876779($_smarty_tpl) {?>
...
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2012-11-01 16:46:24
         compiled from "/www/htdocs/mrtc/testIDT/adm/themes/idt/template/helpers/form/form_initiative.tpl" */ ?>
<?php if ($_valid && !is_callable('content_509299503521b3_30879477')) {function content_509299503521b3_30879477($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_509299503ddbb4_92337977')) {function content_509299503ddbb4_92337977($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_50929950495065_08977052')) {function content_50929950495065_08977052($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_50929950517577_81500284')) {function content_50929950517577_81500284($_smarty_tpl) {?>
...
<?php if ($_valid && !is_callable('content_5092995058cef3_56111665')) {function content_5092995058cef3_56111665($_smarty_tpl) {?>
...
<?php }?><?php }} ?><?php /* Smarty version Smarty-3.1.8, created on 2012-11-01 16:46:24
         compiled from "/www/htdocs/mrtc/testIDT/adm/themes/idt/template/helpers/form/form_supervision.tpl" */ ?>
<?php if ($_valid && !is_callable('content_509299506202b0_38850770')) {function content_509299506202b0_38850770($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/www/htdocs/mrtc/testIDT/tools/smarty/plugins/modifier.escape.php';
?><table>
	<tr>
		<td style="padding-bottom:5px;">
			<input type="hidden" name="inputSupervision" id="inputSupervision" value="<?php  $_smarty_tpl->tpl_vars['student'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['student']->_loop = false;
...
?><?php echo $_smarty_tpl->tpl_vars['student']->value['id_customer'];?>
-<?php } ?>" />
			<input type="hidden" id="id_supervisor" value="<?php echo $_smarty_tpl->tpl_vars['id_supervisor']->value;?>
" />
			<input type="hidden" name="nameSupervision" id="nameSupervision" value="<?php  $_smarty_tpl->tpl_vars['student'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['student']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['students']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['student']->key => $_smarty_tpl->tpl_vars['student']->value){
$_smarty_tpl->tpl_vars['student']->_loop = true;
?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['student']->value['firstname'], 'htmlall', 'UTF-8');?>
 <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['student']->value['lastname'], 'htmlall', 'UTF-8');?>
¤<?php } ?>" />
			<input type="hidden" name="studentIdsFromDb" id="studentIdsFromDb" value="<?php  $_smarty_tpl->tpl_vars['student'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['student']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['students']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['student']->key => $_smarty_tpl->tpl_vars['student']->value){
$_smarty_tpl->tpl_vars['student']->_loop = true;
?><?php echo $_smarty_tpl->tpl_vars['student']->value['id_customer'];?>
-<?php } ?>" />
			<input type="hidden" name="studentNamesFromDb" id="studentNamesFromDb" value="<?php  $_smarty_tpl->tpl_vars['student'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['student']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['students']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['student']->key => $_smarty_tpl->tpl_vars['student']->value){
$_smarty_tpl->tpl_vars['student']->_loop = true;
?><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['student']->value['firstname'], 'htmlall', 'UTF-8');?>
 <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['student']->value['lastname'], 'htmlall', 'UTF-8');?>
¤<?php } ?>" />
			<input type="hidden" name="supervisionTypes" id="supervisionTypes" value="<?php  $_smarty_tpl->tpl_vars['supervision_type'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['supervision_type']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['input']->value['supervision_types']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['supervision_type']->key => $_smarty_tpl->tpl_vars['supervision_type']->value){
$_smarty_tpl->tpl_vars['supervision_type']->_loop = true;
?><?php echo $_smarty_tpl->tpl_vars['supervision_type']->value['name'];?>
-<?php echo $_smarty_tpl->tpl_vars['supervision_type']->value['id_supervision_type'];?>
¤<?php } ?>" />

			<div id="ajax_choose_customer">
				<p style="clear:both;margin-top:0;">
					<input type="text" value="" id="supervision_autocomplete_input" />
...
$_smarty_tpl->tpl_vars['student']->_loop = true;
?>
					<?php $_smarty_tpl->tpl_vars['id_select'] = new Smarty_variable((('supervisionTypeSelect').('_')).($_smarty_tpl->tpl_vars['student']->value['id_customer']), null, 0);?>
					<span class="supervisedStudent"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['student']->value['firstname'], 'htmlall', 'UTF-8');?>
 <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['student']->value['lastname'], 'htmlall', 'UTF-8');?>

						<span class="delSupervision" name="<?php echo $_smarty_tpl->tpl_vars['student']->value['id_customer'];?>
" style="cursor: pointer;">
							<img src="../img/admin/delete.gif" class="middle" alt="" />
						</span>
					</span>
					<select name="supervisionTypeSelect[]" class="supervisionTypeSelect" id="<?php echo $_smarty_tpl->tpl_vars['id_select']->value;?>
">
						<?php  $_smarty_tpl->tpl_vars['supervision_type'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['supervision_type']->_loop = false;
 $_smarty_tpl->tpl_vars['key'] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['input']->value['supervision_types']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['supervision_type']->key => $_smarty_tpl->tpl_vars['supervision_type']->value){
$_smarty_tpl->tpl_vars['supervision_type']->_loop = true;
 $_smarty_tpl->tpl_vars['key']->value = $_smarty_tpl->tpl_vars['supervision_type']->key;
?>
							<option value="<?php echo $_smarty_tpl->tpl_vars['student']->value['id_customer'];?>
_<?php echo $_smarty_tpl->tpl_vars['supervision_type']->value['id_supervision_type'];?>
"
								<?php if ($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['id_select']->value]==(($_smarty_tpl->tpl_vars['student']->value['id_customer']).('_')).($_smarty_tpl->tpl_vars['supervision_type']->value['id_supervision_type'])){?> selected="selected"<?php }?>
							><?php echo $_smarty_tpl->tpl_vars['supervision_type']->value['name'];?>
</option>
						<?php } ?>
					</select>
					<?php $_smarty_tpl->tpl_vars['id_checkbox'] = new Smarty_variable((('formerSupervisorBox').('_')).($_smarty_tpl->tpl_vars['student']->value['id_customer']), null, 0);?>
					
					<input type="checkbox" name="formerSupervisorBox[]" class="formerSupervisorBox" id="<?php echo $_smarty_tpl->tpl_vars['id_checkbox']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['student']->value['id_customer'];?>
" <?php if ($_smarty_tpl->tpl_vars['fields_value']->value[$_smarty_tpl->tpl_vars['id_checkbox']->value]){?>checked="checked"<?php }?> /> Former <br />
				<?php } ?>
			</div>
		</td>
	</tr>
...
<?php if ($_valid && !is_callable('content_50929950739666_71495914')) {function content_50929950739666_71495914($_smarty_tpl) {?><?php if (!is_callable('smarty_function_implode')) include '/www/htdocs/mrtc/testIDT/tools/smarty/plugins/function.implode.php';
?>
