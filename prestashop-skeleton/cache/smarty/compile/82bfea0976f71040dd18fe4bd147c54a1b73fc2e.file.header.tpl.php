<?php /* Smarty version Smarty-3.1.8, created on 2013-05-28 13:48:28
         compiled from "/www/htdocs/mrtc/testIDT/adm/themes/idt-user/template/header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:203174610651a4998c2227e2-63402519%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '82bfea0976f71040dd18fe4bd147c54a1b73fc2e' => 
    array (
      0 => '/www/htdocs/mrtc/testIDT/adm/themes/idt-user/template/header.tpl',
      1 => 1366883778,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '203174610651a4998c2227e2-63402519',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51a4998c675103_67842532',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51a4998c675103_67842532')) {function content_51a4998c675103_67842532($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/www/htdocs/mrtc/testIDT/tools/smarty/plugins/modifier.escape.php';
?>
...
"><?php echo smartyTranslate(array('s'=>'Show all messages'),$_smarty_tpl);?>
		...
		<div style="color:white; padding: 57px 0 0 18px">
			...
			|
			<a href="../es" style="color:white;padding:3px">ES</a>
			|
			<a href="../ipr" style="color:white;padding:3px">IPR</a>
			|
...
<?php }?>
  ...
  <?php echo smartyTranslate(array('s'=>'delete the /install folder'),$_smarty_tpl);?>
		...
		<?php if (0&&$_smarty_tpl->tpl_vars['display_header']->value&&$_smarty_tpl->tpl_vars['is_multishop']->value&&$_smarty_tpl->tpl_vars['shop_list']->value&&($_smarty_tpl->tpl_vars['multishop_context']->value&Shop::CONTEXT_GROUP||$_smarty_tpl->tpl_vars['multishop_context']->value&Shop::CONTEXT_SHOP)){?>
