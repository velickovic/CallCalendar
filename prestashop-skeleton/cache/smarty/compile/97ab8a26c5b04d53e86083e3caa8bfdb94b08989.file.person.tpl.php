<?php /* Smarty version Smarty-3.1.8, created on 2013-05-28 13:29:04
         compiled from "/www/htdocs/mrtc/testIDT/themes/ipr/person.tpl" */ ?>
<?php /*%%SmartyHeaderCode:162674264151a495000dc111-43560127%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '97ab8a26c5b04d53e86083e3caa8bfdb94b08989' => 
    array (
      0 => '/www/htdocs/mrtc/testIDT/themes/ipr/person.tpl',
      1 => 1367923877,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '162674264151a495000dc111-43560127',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_51a49500976a18_87917819',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_51a49500976a18_87917819')) {function content_51a49500976a18_87917819($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/www/htdocs/mrtc/testIDT/tools/smarty/plugins/modifier.escape.php';
...
<div class="centre-column-single">
	<h1><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['person']->value['firstname'], 'htmlall', 'UTF-8');?>
...
<?php if ($_smarty_tpl->tpl_vars['person']->value['title']!=''){?>, <span style="color:#666;font-style:italic;font-size:0.8em;"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['person']->value['title'], 'htmlall', 'UTF-8');?>
	...
	<div class="centre-block">
		<?php if (file_exists("img/staff/".($_smarty_tpl->tpl_vars['person']->value['id_customer'])."-staff.jpg")){?>
			<div class="div-photo">
...
-<?php echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['phd_student']->value['firstname'],"/[^A-Za-z0-9]/","_");?>
_<?php echo smarty_modifier_regex_replace($_smarty_tpl->tpl_vars['phd_student']->value['lastname'],"/[^A-Za-z0-9]/","_");?>
">
...
?>
						<?php if ($_smarty_tpl->tpl_vars['position']->value['name']=='Doctoral student'){?>
							<?php $_smarty_tpl->tpl_vars['is_phd_student'] = new Smarty_variable(1, null, 0);?> 									
						<?php }?> 
					<?php } ?>
					
					<?php if ($_smarty_tpl->tpl_vars['phd_student']->value['away']==1||$_smarty_tpl->tpl_vars['is_phd_student']->value==0){?>
						(former)
					<?php }?>
					<br>
				<?php } ?>
