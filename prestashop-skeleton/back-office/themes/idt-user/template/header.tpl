...
*  @version  Release: $Revision: 17278 $
...
{* begin  HEADER *}
	<div id="header">
		<div id="header_infos">
			<a id="header_shopname" href="{$link->getAdminLink('AdminHome')|escape:'htmlall':'UTF-8'}"><span>{$shop_name} Internal</span></a><div id="notifs_icon_wrapper">
	...
	<div id="main">
		...
		{if $display_header && $is_multishop && $shop_list && ($multishop_context & Shop::CONTEXT_GROUP || $multishop_context & Shop::CONTEXT_SHOP)}
			<div class="multishop_toolbar">
				<span class="text_multishop">{l s='Profile:'}</span>
				{$shop_list}
			</div>
		{/if}
